...
def emit_lints(fixable_lints_path: Path | None = None) -> str:
    ...
    lines = [
        "# Auto-generated by scripts/recommended-config.py --format lints",
        "",
        "[lints.rust]",
    ]
...
set -euo pipefail
# Auto-generated by scripts/recommended-config.py --format hook
...
for (( i=0; i<5; i++ )); do
  ...
  echo "$output"
  echo "$output" | grep -q 'Fixed' || break
done
...
# 4. Re-stage files modified by auto-fix and formatting.
