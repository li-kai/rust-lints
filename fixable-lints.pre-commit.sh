...
cargo clippy --fix --allow-dirty --allow-staged -- \
  ...
  -W clippy::deprecated_cfg_attr \
  -W clippy::deprecated_clippy_cfg_attr \
  -W clippy::deref_addrof \
  ...
  -W clippy::unnecessary_join \
  -W clippy::unnecessary_lazy_evaluations \
